  ...
  return (
    <div className="pixel-page min-h-screen bg-background">
      ...
      <header className="app-shell-header sticky top-0 z-50 w-full border-b border-border bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/60">
        <nav className="mx-auto flex h-16 max-w-[1200px] items-center justify-between px-4 lg:px-8">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1200px] px-4 py-20 lg:px-8 lg:py-32">
          ...
          <div className="mt-20 relative">
            ...
            <Card className="pixel-panel overflow-hidden border-2 shadow-2xl">
              ...
              <CardContent className="p-0">
                <div className="relative h-[400px] bg-card overflow-hidden">
        ...
        <div className="mx-auto max-w-[1200px] px-4 lg:px-8">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {features.map((feature, index) => (
              <Card key={index} className="pixel-panel group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="mx-auto max-w-[1200px] px-4 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            ...
            <div className="relative">
              <Card className="pixel-panel bg-card text-card-foreground">
                <CardContent className="p-6">
        ...
        <div className="mx-auto max-w-[1200px] px-4 lg:px-8">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="pixel-panel h-full">
      ...
      <section className="py-20 lg:py-32 bg-muted/50">
        <div className="mx-auto max-w-[1200px] px-4 lg:px-8 text-center">
