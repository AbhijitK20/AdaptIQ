...
INSERT INTO public.questions (id, concept_id, question_text, question_type, options, correct_answer, explanation, difficulty) VALUES
  ...
  ('a0000001-0001-0001-0001-000000000001', 'c0000001-0001-0001-0001-000000000001', 
  ...
  ('a0000001-0001-0001-0001-000000000002', 'c0000001-0001-0001-0001-000000000001',
  ...
  ('a0000001-0001-0001-0001-000000000003', 'c0000001-0001-0001-0001-000000000005',
   'Solve for x: 3x + 7 = 22', 'mcq',
   '["x = 3", "x = 5", "x = 7", "x = 15"]'::jsonb, 'x = 5',
   'Subtract 7 from both sides: 3x = 15. Then divide by 3: x = 5.', 1),
  
  ('a0000001-0001-0001-0001-000000000004', 'c0000001-0001-0001-0001-000000000005',
  ...
  ('a0000001-0001-0001-0001-000000000005', 'c0000001-0001-0001-0001-000000000007',
  ...
  ('a0000001-0001-0001-0001-000000000006', 'c0000001-0001-0001-0001-000000000007',
   'The discriminant of 2x² + 3x - 5 = 0 is:', 'mcq',
   '["49", "41", "-31", "9"]'::jsonb, '49',
   'Discriminant = b² - 4ac = 3² - 4(2)(-5) = 9 + 40 = 49', 3),
  
  -- Factorization questions
  ('a0000001-0001-0001-0001-000000000007', 'c0000001-0001-0001-0001-000000000008',
   'Factorize: x² - 9', 'mcq',
   '["(x+3)(x+3)", "(x-3)(x-3)", "(x+3)(x-3)", "(x+9)(x-1)"]'::jsonb, '(x+3)(x-3)',
   'This is a difference of squares: a² - b² = (a+b)(a-b). Here a=x, b=3.', 1),
  
  ('a0000001-0001-0001-0001-000000000008', 'c0000001-0001-0001-0001-000000000008',
  ...
  ('a0000001-0001-0001-0001-000000000009', 'c0000001-0001-0001-0001-000000000011',
  ...
  ('a0000001-0001-0001-0001-000000000010', 'c0000001-0001-0001-0001-000000000011',
  ...
  ('a0000001-0001-0001-0001-000000000011', 'c0000001-0001-0001-0001-000000000004',
   'Simplify: 3x + 2y - x + 4y', 'mcq',
   '["2x + 6y", "4x + 6y", "2x + 2y", "3x + 6y"]'::jsonb, '2x + 6y',
   'Combine like terms: (3x - x) + (2y + 4y) = 2x + 6y', 1),
  
  ('a0000001-0001-0001-0001-000000000012', 'c0000001-0001-0001-0001-000000000004',
