...
// Seeded shuffle function for consistent option order per question
...
// Generate a numeric seed from question ID
function generateSeed(questionId: string): number {
  let hash = 0;
...
export function QuestionCard({ 
  ...
  // Shuffle options based on question ID for consistent but varied order
